 ...
 *
 * ponytail: the session lives in memory, so the app needs no extra native modules
 * (SecureStore/AsyncStorage) to run in Expo Go. Swap in expo-secure-store when we add
